...
// Buscar veículos da tabela veiculos_venda com categoria principal ou opcionais = 8 (UTE/Picape) e visivel = 1 e pausa = 1
$sql = "SELECT imagem_principal, nome FROM veiculos_venda WHERE (categoria_id = 8 OR categoria_idop1 = 8 OR categoria_idop2 = 8) AND visivel = 1 AND pausa = 1";
$res = $con->query($sql);
...
<html lang="en">
  <head>
    ...
    <link href="/CRUDTCC/css/ute_picape.css" rel="stylesheet">
  </head>
  <body<?php if ($tema === 'dark') { echo ' class=\"dark-mode\"'; } elseif ($tema === 'light') { echo ' class=\"light-mode\"'; } ?>>
    ...
    <div class="main-box" style="background:rgba(255,255,220,0.92);border-radius:18px;margin:24px 0 0 0;box-shadow:0 2px 16px rgba(0,0,0,0.07);padding:32px 0;min-height:70vh;">
      <h1 class="text-center mb-4" style="font-weight:700;letter-spacing:1px;">UTE/Picapes</h1>
      <div class="container">
