...
// Buscar veículos da tabela veiculos_venda com categoria principal ou opcionais = 7 (SUV) e visivel = 1 e pausa = 1
$sql = "SELECT imagem_principal, nome FROM veiculos_venda WHERE (categoria_id = 7 OR categoria_idop1 = 7 OR categoria_idop2 = 7) AND visivel = 1 AND pausa = 1";
$res = $con->query($sql);
...
<html lang="en">
  <head>
    ...
    <link href="/CRUDTCC/css/suv.css" rel="stylesheet">
  </head>
