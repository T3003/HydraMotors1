...
<html lang="en">
  <head>
    ...
    <link href="/css/antiguidade.css" rel="stylesheet">
  </head>
  <body<?php if ($tema === 'dark') { echo ' class="dark-mode"'; } elseif ($tema === 'light') { echo ' class="light-mode"'; } ?>>
    ...
    <script>
      ...
      // Persist dark mode, mas só se não veio via GET
      <?php if (!$tema): ?>
      // Se vier da index.php, tente pegar o tema da URL da index
      (function() {
        var params = new URLSearchParams(window.location.search);
        var temaIndex = params.get('tema');
        if (temaIndex === 'dark') {
          document.body.classList.add('dark-mode');
        } else if (temaIndex === 'light') {
