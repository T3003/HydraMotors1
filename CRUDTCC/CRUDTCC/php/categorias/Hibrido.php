...
// Consulta correta para híbridos (catid, catidop1 ou catidop2 = 6)
$sql = "SELECT carimg, carnome FROM car WHERE catid = 8 OR catidop1 = 8 OR catidop2 = 8 OR catid = 6 OR catidop1 = 6 OR catidop2 = 6";
...
<html lang="en">
  <head>
    ...
    <link href="/css/hibrido.css" rel="stylesheet">
  </head>
  <body>
    ...
    <div class="main-box" style="background:rgba(255,255,220,0.92);border-radius:18px;margin:24px 0 0 0;box-shadow:0 2px 16px rgba(0,0,0,0.07);padding:32px 0;min-height:70vh;">
      <h1 class="text-center mb-4" style="font-weight:700;letter-spacing:1px;">Híbridos</h1>
      <div class="container">
