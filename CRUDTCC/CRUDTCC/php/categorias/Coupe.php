...
// Corrigido para buscar apenas carros da categoria Coupe (catid = 8)
$sql = "SELECT carimg, carnome FROM car WHERE catid = 7 OR catidop1 = 7 OR catidop2 = 7";
...
<html lang="en">
  <head>
    ...
    <link href="/css/coupe.css" rel="stylesheet">
  </head>
  <body>
    ...
    <div class="main-box" style="background:rgba(255,255,220,0.92);border-radius:18px;margin:24px 0 0 0;box-shadow:0 2px 16px rgba(0,0,0,0.07);padding:32px 0;min-height:70vh;">
      <h1 class="text-center mb-4" style="font-weight:700;letter-spacing:1px;">Coupé</h1>
      <div class="container">
